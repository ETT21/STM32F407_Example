...
#define configSYSTICK_CLOCK_HZ                          configCPU_CLOCK_HZ      /* 定义SysTick时钟频率，当SysTick时钟频率与内核时钟频率不同时才可以定义, 单位: Hz, 默认: 不定义 */
...
#define configTOTAL_HEAP_SIZE                           ((size_t)(16 * 1024))   /* FreeRTOS堆中可用的RAM总量, 单位: Byte, 无默认需定义 */
